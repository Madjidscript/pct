...
const Profils = (props) => {
    ...
    <div className="ladder  container">
      <h3><NavLink to="/artisan/" style={{marginLeft:"4px"}}>Acceuil</NavLink></h3>
      <h3><NavLink to="/artisan/edit/:id">Edit Profil</NavLink></h3>
      <h3><NavLink to="/artisan/realisation/:id">Ajout Realisation</NavLink></h3>
